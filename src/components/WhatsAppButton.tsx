...
const WhatsAppButton: React.FC = () => {
  ...
  return (
    ...
    >
      <div className={`flex items-center gap-2 overflow-hidden transition-all duration-300 ${isHovered ? 'pl-4 pr-2 max-w-xs' : 'p-0 max-w-0'}`}>
        <span className="whitespace-nowrap font-medium text-sm">Chat with us</span>
      </div>
