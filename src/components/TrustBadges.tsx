  ...
  const badges = [
    {
      ...
      description: 'Strict quality control on all products',
    },
    {
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Local manufacturer since 2016',
    },
    {
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      title: 'UV & Climate Resistant',
      description: 'Built for African conditions',
    },
    {
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Reliable supply chain across SA',
    },
  ];
